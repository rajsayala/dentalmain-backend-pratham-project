...
export default function Answers() {
    ...
    const getAnswers = () => { 
        ...
        if(params.categoryId) jsonData.category = params.categoryId;
    ...
    useEffect(() => {
        if(params?.categoryId || params?.userId) getAnswers();
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                {params.categoryId && <h1 className="m-0">Answer</h1>}
                                {params.userId && <h1 className="m-0">Results</h1>}
                            </div>
                            <div className="col-sm-6">
                                {params.categoryId && <ol className="breadcrumb float-sm-right">
                            ...
                            <div className="col-md-12">
                                <div className="card">
                                    <div className="card-header">
                                        {params.categoryId && <h3 className="card-title">Answer List</h3>}
                                        ...
                                        <table className="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    {params.categoryId && <th>Customer</th>}
                                            ...
                                            <tbody>
                                                ...
                                                {answers?.map((answer, i) => (
                                                    <tr key={i}>
                                                        <td>{i+1}.</td>
                                                        {params.categoryId && <td>{answer.user?.first_name} {answer.user?.last_name}</td>}
